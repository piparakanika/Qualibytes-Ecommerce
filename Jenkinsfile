...
pipeline {
    ...
    environment {
        ...
        DOCKER_IMAGE_NAME = 'kanika2905/qbshop-app'
        DOCKER_MIGRATION_IMAGE_NAME = 'kanika2905/qbshop-migration'
    ...
    stages {
        ...
        stage('Clone Repository') {
            steps {
                script {
                    clone("https://github.com/piparakanika/Qualibytes-Ecommerce.git", "dev")
                }
            }
        }
